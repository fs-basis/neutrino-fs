...
struct NeutrinoMessages {
	enum
	{
		...
		STANDBY_ON		=	CRCInput::RC_Messages + 3,
		STANDBY_OFF		=	CRCInput::RC_Messages + 4,
		STANDBY_TOGGLE		=	CRCInput::RC_Messages + 5,
		SHUTDOWN		=	CRCInput::RC_Messages + 6,
		ANNOUNCE_SHUTDOWN	=	CRCInput::RC_Messages + 7,
		...
		LOCK_RC                 =       CRCInput::RC_Messages + 17,
		UNLOCK_RC               =       CRCInput::RC_Messages + 18,
		LOCK_RC_EXTERN          =       CRCInput::RC_Messages + 19,
		UNLOCK_RC_EXTERN        =       CRCInput::RC_Messages + 20,
		...
		EVT_MODECHANGED                          = CRCInput::RC_Events + 3,
		EVT_BOUQUETSCHANGED                      = CRCInput::RC_Events + 4,
		EVT_SERVICESCHANGED                      = CRCInput::RC_Events + 5,
