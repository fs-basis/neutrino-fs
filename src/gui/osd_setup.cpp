...
font_sizes_struct neutrino_font[SNeutrinoSettings::FONT_TYPE_COUNT] =
{
	...
	{LOCALE_FONTSIZE_SUBTITLES          ,  24, CNeutrinoFonts::FONT_STYLE_BOLD   , 0},
...
#if 1 /* use only FS */
#define LOCALE_MISCSETTINGS_INFOBAR_DISP_OPTIONS_COUNT 2
...
void COsdSetup::showOsdInfobarSetup(CMenuWidget *menu_infobar)
{
	...
	// show channelnumber
	mc = new CMenuOptionChooser(LOCALE_MISCSETTINGS_INFOBAR_SHOW_CHANNELNUMBER, &g_settings.infobar_show_numbers, OPTIONS_OFF0_ON1_OPTIONS, OPTIONS_OFF0_ON1_OPTION_COUNT, true);
	mc->setHint("", LOCALE_MENU_HINT_INFOBAR_SHOW_CHANNELNUMBER);
	menu_infobar->addItem(mc);
...
void COsdSetup::showOsdChanlistSetup(CMenuWidget *menu_chanlist)
{
	...
	// scramble-icon
	mc = new CMenuOptionChooser(LOCALE_CHANNELLIST_SCRAMBLEICON, &g_settings.channellist_scrambleicon, OPTIONS_OFF0_ON1_OPTIONS, OPTIONS_OFF0_ON1_OPTION_COUNT, true);
	mc->setHint("", LOCALE_MENU_HINT_CHANNELLIST_SCRAMBLEICON);
	menu_chanlist->addItem(mc);
