...
CMenuOptionChooser::keyval_ext VIDEOMENU_VIDEOMODE_OPTIONS[VIDEOMENU_VIDEOMODE_OPTION_COUNT] =
{
	{ -1,                NONEXISTANT_LOCALE, "NTSC"		}, //  0
	{ VIDEO_STD_PAL,     NONEXISTANT_LOCALE, "PAL"		}, //  2 
	{ -1,                NONEXISTANT_LOCALE, "SECAM"	}, //  1
	{ -1,                NONEXISTANT_LOCALE, "480p"		}, //  3
	{ VIDEO_STD_576P,    NONEXISTANT_LOCALE, "576p"		}, //  4
	{ VIDEO_STD_720P50,  NONEXISTANT_LOCALE, "720p 50Hz"	}, //  7
	{ VIDEO_STD_720P60,  NONEXISTANT_LOCALE, "720p 60Hz"	}, //  5
	{ VIDEO_STD_1080I50, NONEXISTANT_LOCALE, "1080i 50Hz"	}, //  8
	{ VIDEO_STD_1080I60, NONEXISTANT_LOCALE, "1080i 60Hz"	}, //  6
	{ VIDEO_STD_1080P24, NONEXISTANT_LOCALE, "1080p 24Hz"	}, // 10
	{ VIDEO_STD_1080P25, NONEXISTANT_LOCALE, "1080p 25Hz"	}, // 11
	{ VIDEO_STD_1080P50, NONEXISTANT_LOCALE, "1080p 50Hz"	}, // 12
	{ VIDEO_STD_2160P24, NONEXISTANT_LOCALE, "2160p 24Hz"	}, // 16
	{ VIDEO_STD_2160P25, NONEXISTANT_LOCALE, "2160p 25Hz"	}, // 17
	{ VIDEO_STD_2160P30, NONEXISTANT_LOCALE, "2160p 30Hz"	}, // 18
	{ VIDEO_STD_2160P50, NONEXISTANT_LOCALE, "2160p 50Hz"	}, // 19
	{ -1,                NONEXISTANT_LOCALE, "Auto"		}  // 20
