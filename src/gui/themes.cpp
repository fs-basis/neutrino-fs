...
void CThemes::getTheme(CConfigFile &configfile)
{
	...
	t.menu_Foot_Text_red = configfile.getInt32( "menu_Foot_Text_red", 0x64 );
	t.menu_Foot_Text_green = configfile.getInt32( "menu_Foot_Text_green", 0x64 );
	t.menu_Foot_Text_blue = configfile.getInt32( "menu_Foot_Text_blue", 0x64 );
