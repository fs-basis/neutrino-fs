...
class CNaviBar : public CComponentsFrmChain
{
	...
	public:
		...
		*/
		void enableLeftArrow(bool enable = true)
		{
			nb_lpic_enable = enable;
			initCCItems();
		}
		...
		* 	@li 	expects type bool, default = true
		*/
		void enableRightArrow(bool enable = true)
		{
			nb_rpic_enable = enable;
			initCCItems();
		}
		...
		* 	@li 	expects type bool, default = true
		*/
		void enableArrows(bool enable_left = true, bool enable_right = true)
		{
			enableLeftArrow(enable_left);
			enableRightArrow(enable_right);
		}
